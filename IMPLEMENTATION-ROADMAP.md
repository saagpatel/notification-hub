...
- The current operator loop includes `/review` Operator Focus, Coordination Readiness,
  Coordination Console with active/handled proposal lineage and guide steps, and saved queue burn-in
  report history for real-use evidence before broader coordination expansion
