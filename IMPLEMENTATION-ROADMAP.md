...
- The current operator loop includes `/review` Operator Focus, Coordination Readiness, and saved
  queue burn-in report history for real-use evidence before broader coordination expansion
